Feature: Adding and removing wines from the wishlist
  Scenario: CT_WishList_1: The user has no wines in their wishlist and adds a wine to their wishlist
  ...
  Scenario: CT_WishList_2: The user has 1 wine in their wishlist and removes it
  ...
  Scenario: CT_WishList_3: The user has a wishlist and adds multiple wines to it
  ...
  Scenario: CT_WishList_4: There are two users in the database, and one users wishlist doesn't effect the other ones wishlist
  ...
  Scenario: CT_WishList_5: There are two users in the database both have the same wine in their wishlist
