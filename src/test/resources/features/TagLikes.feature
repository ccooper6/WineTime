...
Feature: Liking/Disliking a tag or multiple tags
  ...
  Scenario: CT_Tag_4: Liking multiple tags
    Given The user with name "name", username "username" and password "password1" is currently logged in. Their user id is 1
  ...
  Scenario: CT_Tag_5: First liking no tags, then editing the review to only select one tag
    Given The user with name "name", username "username" and password "password1" is currently logged in. Their user id is 1
  ...
  Scenario: CT_Tag_6: First liking tags, then editing the review to only select no tags
    Given The user with name "name", username "username" and password "password1" is currently logged in. Their user id is 1
    When The user is in the wine logging popup with the wine with id 4 which has the tags [CalebIsCool, Italy, 1969, Cooooool]
