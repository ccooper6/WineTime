Feature: Participate in Challenge
  Scenario: CT_Challenge_1: User starts the Variety challenge
  ...
  Scenario: CT_Challenge_7: Other users challenge not affecting each others challenges
