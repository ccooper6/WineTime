Feature: Quiz result feature
  Scenario: CT_Quiz_1: User has completed the quiz answering only first option, leading to a wine between 1990 and 1999 from the US
  ...
  Scenario: CT_Quiz_2: User has completed the quiz answering only second option, leading to a wine between 2000 and 2004 from New Zealand
